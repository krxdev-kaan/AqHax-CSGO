...
namespace AqHaxCSGO.MemoryManagers
{
    static class OffsetManager
    {
        ...
        public static void ScanOffsets()
        {
            ...
            dwClientState_ViewAngles = SigScanner.EngineSigScan("F3 0F 11 86 ? ? ? ? F3 0F 10 44 24 ? F3 0F 11 86", 4, 0, false);
            ...
            m_hTonemapControllerIndex = NetvarManager.GetOffsetByName("DT_CSPlayer", "m_hTonemapController");
            m_bUseCustomBloomScale = NetvarManager.GetOffsetByName("DT_EnvTonemapController", "m_bUseCustomBloomScale");
            m_bUseCustomAutoExposureMin = NetvarManager.GetOffsetByName("DT_EnvTonemapController", "m_bUseCustomAutoExposureMin");
            m_bUseCustomAutoExposureMax = NetvarManager.GetOffsetByName("DT_EnvTonemapController", "m_bUseCustomAutoExposureMax");
            m_flCustomBloomScale = NetvarManager.GetOffsetByName("DT_EnvTonemapController", "m_flCustomBloomScale");
            m_flCustomAutoExposureMin = NetvarManager.GetOffsetByName("DT_EnvTonemapController", "m_flCustomAutoExposureMin");
            m_flCustomAutoExposureMax = NetvarManager.GetOffsetByName("DT_EnvTonemapController", "m_flCustomAutoExposureMax");
